...
const HEWEATHER_API = 'https://api.seniverse.com/v3'

module.exports = {
  // 和风天气个人开发key 对外提供 d469334ef67548578d65268f148b046f
  weatherKey: '5msxqxpy0gqkppfr',
  // 腾讯地图开发key
  qqMapKey: '',
  // 实时天气接口地址 https://api.seniverse.com/v3/weather/now.json
  nowWeatherUrl: `${HEWEATHER_API}/weather/now.json`,
  // 逐日天气接口地址
  dailyWeatherUrl: `${HEWEATHER_API}/weather/daily.json`,
  // 逐三小时预报
  hourlyWeatherUrl: `${HEWEATHER_API}/weather/hourly.json`,
  // 生活指数接口地址
  lifestyleUrl: `${HEWEATHER_API}/life/suggestion.json`,
  airQualityUrl:`${HEWEATHER_API}/air/now.json`,
  // 天气图标基地址
  COND_ICON_BASE_URL: 'https://6465-demo-57510e-1257978613.tcb.qcloud.la/miniWeather/images/cond-white',
  // 背景图片基地址
  BG_IMG_BASE_URL: 'http://p1.qhmsg.com/t01adb794bb858deedf.png',
  LOCATION_IMG_URL:"https://6465-demo-57510e-1257978613.tcb.qcloud.la/miniWeather/images/icon/location_s_w.png",
  CLOUD_IMG_URL:"//s4.sencdn.com/web/icons/3d_50",
  // BG_IMG_BASE_URL: '../imgs/t01adb794bb858deedf.png',
